          ...
          <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:12 }}>
            ...
            <div className="reg-row">
              <div>
                ...
                <input className="reg-input" type="password" value={form.senha}
                  onChange={e=>set("senha",e.target.value)} required minLength={8} placeholder="Mín. 8 caracteres" />
              </div>
              <div>
                <label className="reg-label">CONFIRMAR</label>
                <input className="reg-input" type="password" value={form.confirmar}
                  onChange={e=>set("confirmar",e.target.value)} required placeholder="Repita a senha" />
              </div>
            </div>
