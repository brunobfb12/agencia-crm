...
const MSG = encodeURIComponent("Olá! Preciso de ajuda com o FácilCRM.");
...
export default function SupportButton() {
  return (
    <a
      ...
      style={{
        position:"fixed",bottom:24,right:150,zIndex:9999,
      ...
      onMouseEnter={e=>{
        ...
        el.style.boxShadow="0 8px 32px rgba(37,211,102,.7)";
      }}
      onMouseLeave={e=>{
        const el = e.currentTarget as HTMLAnchorElement;
