...
const sistemaParts = [
  ...
  '',
  'QUANDO notificarVendedor=true, mensagemVendedor DEVE ser COMPLETO para o vendedor abordar bem o cliente. Inclua obrigatoriamente:',
  ...
  '  - Objecoes ou preocupacoes do cliente (ex: medo de links, preco alto, distancia, tempo)',
  '  - Tom: animado, hesitante, com pressa, comparando concorrentes, etc',
  '  - Proximo passo recomendado para o vendedor',
  ...
  '  Exemplo: "[Nome] | Interesse: [servico especifico] | Preco: [perguntou sim/nao + valor se houver] | Local: [info] | Disponivel: [quando] | Tom: [animado/hesitante] | Objecoes: [lista] | Acao: [proximo passo]"',
