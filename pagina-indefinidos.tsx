// ============================================================
// FACILCRM V2 — app/v/[token]/page.tsx
// Página de indefinidos — substitui a página de pressão atual
// ============================================================
"use client";
...
export default function VendedorPage({ params }: { params: { token: string } }) {
  ...
  async function agir(leadId: string, acao: "venda" | "derrota" | "balcao") {
    ...
    try {
      ...
      const r = await fetch(`/api/v/${params.token}`, {
        method: "POST",
